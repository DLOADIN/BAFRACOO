    ...
    <main class="main-content">
      ...
      <div class="page-banner">
        <h1 class="page-banner-title">
          <ion-icon name="<?php echo $is_edit ? 'create-outline' : 'add-circle-outline'; ?>"></ion-icon>
          <?php echo $is_edit ? 'Edit Order' : 'Add New Order'; ?>
        </h1>
        <p class="page-banner-subtitle"><?php echo $is_edit ? 'Update the order details below' : 'Create a new order for a customer'; ?></p>
      </div>
